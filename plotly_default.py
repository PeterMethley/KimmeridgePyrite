...
axis_layout_3D = dict(
    showline=True, ticks="outside", linewidth=2, color=black_color, gridcolor=grid_color
)
...
pio.templates["PM_graph_1"] = go.layout.Template(
    layout=dict(
        ...
        hovermode="closest",
        scene={
            "xaxis": axis_layout_3D,
            "yaxis": axis_layout_3D,
            "zaxis": axis_layout_3D,
        },
        font_family="Segoe UI",
        font_size=20,
        font_color=black_color,  # Default font size = 1
